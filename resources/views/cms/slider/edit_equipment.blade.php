                ...
                <div class="row">
                    <div class="col-6 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" value="{{ $equipment->title }}" name="title"
                    ...
                    <div class="col-6 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="hidden" name="old_equipment_image" value="{{ $equipment->images[0]->name }}">
                            <a href="{{ asset('storage/upload/' . $equipment->images[0]->name) }}" target="_blank">
                                <!--<img src="{{ asset('thumbnails/' . $equipment->images[0]->name) }}" alt="">-->
                                <img src="{{ asset('storage/upload/' . $equipment->images[0]->name) }}" alt="" height="100">
                            </a>
                        </div>
                    </div>
                </div>
