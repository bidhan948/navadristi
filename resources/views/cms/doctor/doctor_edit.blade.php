...
@section('main_content')
    <div class="card text-sm ">
        ...
        <!-- /.card-header -->
        <div class="card-body">
            <form method="post" action="{{ route('doctor.update', $doctors) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-6">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" value="{{ $doctors->title }}" name="title"
                        ...
                        <div class="input-group input-group-sm">
                            ...
                            <select name="page_id" id=""
                                ...
                                <option value="{{ $department->id }}"
                                    {{ $department->id == $doctors->page_id ? 'selected' : '' }}>
                                    {{ $department->title }}
                                </option>
                                @endforeach
                                </option>
                    ...
                    @if ($doctors->images->count() == 1)
                        <div class="col-6 mb-3">
                            <a href="{{ asset('storage/upload/' . $doctors->image[0]->name) }}" target="_blank">
                                <img src="{{ asset('storage/upload/' . $doctors->image[0]->name) }}">
                            </a>
                        </div>
                    @endif
                    @foreach ($doctors->images as $image)
                        <div class="col-6 mb-3">
                            <a href="{{ asset('storage/upload/' . $image->name) }}" target="_blank">
                                <img src="{{ asset('storage/upload/' . $image->name) }}" height="100">
                            </a>
                        </div>
                        @if ($image->is_banner)
                        ...
                        @if (!$image->is_banner)
                            <input type="hidden" name="old_doctor_image" value="{{ $image->name }} ">
                        @endif
                    @endforeach
                    <div class="col-6 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" value="{{ $metaData['speciality'] }}" name="speciality"
                    ...
                    <div class="col-6 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" value="{{ $metaData['nmc_no'] }}" name="nmc_no"
                   ...
                   <div class="col-12 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <textarea id="editor3" name="past_affilation">{!! $metaData['past_affilation'] !!}</textarea>
                    ...
                    <div class="col-12 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <textarea name="education" id="editor2">{!! $metaData['education'] !!}</textarea>
                        </div>
                    </div>
                      <div class="col-12 mb-4">
                         <div class="input-group input-group-sm">
                            ...
                            <textarea id="editor1" name="membership">{!! $metaData['membership'] !!}</textarea>
                            @error('educatpast_affilationion')
                                <p class="invalid-feedback" style="font-size: 1rem">
                                    {{ __('Past Affiliation field is required') }}
                                </p>
                    ...
                    <div class="col-6 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" value="{{ $metaData['facebook_link'] ?? '' }}" name="facebook_link"
                    ...
                    <div class="col-6 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" value="{{ $metaData['twitter_link'] ?? '' }} " name="twitter_link"
                    ...
                    <div class="col-6 mb-3">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" value="{{ $metaData['instagram_link'] ?? '' }}" name="instagram_link"
                    ...
                    @foreach (config('week') as $week)
                        <div class="col-6 mb-3">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="time" value="{{ $metaData[$week . '_start'] ?? '' }}"
                                    name="{{ $week . '_start' }}" class="form-control ">
                            </div>
                        </div>
                        <div class="col-6 mb-3">
                            <div class="input-group input-group-sm">
                                ...
                                <input type="time" value="{{ $metaData[$week . '_end'] ?? '' }}"
                                    name="{{ $week . '_end' }}" class="form-control ">
                            </div>
                        </div>
                    @endforeach
                </div>
                <div class="col-4 my-2 mx-0">
                    <button type="submit" class="btn btn-primary btn-sm" style="margin-left:-6px;"><i
                            class="fa-solid fa-pen-fancy px-1"></i>
                        update</button>
                </div>
        </div>
